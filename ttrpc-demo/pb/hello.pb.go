...
var fileDescriptor_61ef911816e0a8ce = []byte{
	...
	0x54, 0x21, 0x29, 0x2e, 0x8e, 0x22, 0x28, 0x1b, 0xaa, 0x0e, 0xce, 0x37, 0x4a, 0xe2, 0xe2, 0x77,
	0x2f, 0x4a, 0x4d, 0x2d, 0xc9, 0xcc, 0x4b, 0x0f, 0x4e, 0x2d, 0x2a, 0xcb, 0x4c, 0x4e, 0x15, 0xd2,
	0xe4, 0xe2, 0x80, 0x09, 0x09, 0xf1, 0xea, 0x21, 0x5b, 0x26, 0xc5, 0xa7, 0x87, 0x6a, 0xb2, 0x0a,
	0x17, 0xb3, 0x53, 0x65, 0x2a, 0x01, 0x55, 0x4e, 0xf2, 0x27, 0x1e, 0xca, 0x31, 0xdc, 0x78, 0x28,
	0xc7, 0xd0, 0xf0, 0x48, 0x8e, 0xf1, 0xc4, 0x23, 0x39, 0xc6, 0x0b, 0x8f, 0xe4, 0x18, 0x1f, 0x3c,
	0x92, 0x63, 0x8c, 0x62, 0x05, 0xfb, 0x2c, 0x89, 0x0d, 0xec, 0x35, 0x63, 0x40, 0x00, 0x00, 0x00,
	0xff, 0xff, 0xa7, 0x1f, 0x0e, 0x21, 0xe9, 0x00, 0x00, 0x00,
}
...
type GreetingServiceService interface {
	...
	Bye(ctx context.Context, req *HelloRequest) (*HelloResponse, error)
}
...
func RegisterGreetingServiceService(srv *github_com_containerd_ttrpc.Server, svc GreetingServiceService) {
	srv.Register("GreetingService", map[string]github_com_containerd_ttrpc.Method{
		...
		"Bye": func(ctx context.Context, unmarshal func(interface{}) error) (interface{}, error) {
			var req HelloRequest
			if err := unmarshal(&req); err != nil {
				return nil, err
			}
			return svc.Bye(ctx, &req)
		},
	})
}
...
func (c *greetingServiceClient) Bye(ctx context.Context, req *HelloRequest) (*HelloResponse, error) {
	var resp HelloResponse
	if err := c.client.Call(ctx, "GreetingService", "Bye", req, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
